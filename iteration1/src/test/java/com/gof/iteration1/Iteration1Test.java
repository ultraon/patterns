...
public class Iteration1Test {
    ...
    private IRemoteOutputAPIProvider remoteOutputAPIProvider;
    private RemoteOutputAPI remoteOutputAPI;
    private RemoteInputAPI remoteInputAPI;

    @Before
    public void init() {
        remoteOutputAPIProvider = new RemoteOutputAPIProvider();
        remoteOutputAPI = remoteOutputAPIProvider.provideRemoteOutputAPI();
