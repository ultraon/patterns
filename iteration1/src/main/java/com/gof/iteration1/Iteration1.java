...
/**
 * Service Locator pattern variant
 */
public class Iteration1 {
    private static IRemoteOutputAPIProvider remoteOutputAPIProvider = new RemoteOutputAPIProvider();

    private static final RemoteInputAPI RM_IN = new RemoteInputAPI();
    private static final RemoteOutputAPI RM_OUT = remoteOutputAPIProvider.provideRemoteOutputAPI();
